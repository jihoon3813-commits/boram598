      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="bg-white h-16 border-b border-zinc-200 flex items-center justify-between px-4 lg:px-6 shrink-0 z-30">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <Link to={partnerInfo ? `/${partnerInfo.loginId}` : "/"} target="_blank" className="px-3 py-2 lg:px-4 lg:py-1.5 rounded-md bg-zinc-900 text-white hover:bg-zinc-800 transition-all flex items-center gap-2 shadow-sm">
              <ExternalLink size={18} className="lg:w-4 lg:h-4" />
              <span className="hidden lg:inline text-sm font-bold">분양몰 바로가기</span>
            </Link>
          </div>
        </header>
